...
describe( "牌型检测", function () {
    ...
    describe( "三条CT_THREE", function () {
        ...
        checkPokerType( [ 0x03, 0x13, 0x23, 0x05, 0x15 ], EPokerType.CT_THREE_LINE_TAKE_TWO );
    ...
    describe( "三带一CT_THREE_TAKE_ONE", function () {
        ...
        checkPokerType( [ 0x03, 0x13, 0x23, 0x33 ], EPokerType.CT_BOMB );
        checkPokerType( [ 0x04, 0x14, 0x24, 0x05, 0x15, 0x25, 0x01, 0x02 ], errExpect );
    } )
    describe( "三带二CT_THREE_TAKE_TWO", function () {
        ...
        checkPokerType( [ 0x05, 0x15, 0x25, 0x06, 0x16, 0x07, 0x17 ], sucExpect );
    ...
    describe( "三带一 飞机 CT_THREE_LINE_TAKE_ONE", function () {
        ...
        let errExpect = EPokerType.CT_ERROR;
        checkPokerType( [ 0x05, 0x15, 0x25, 0x06, 0x16, 0x26, 0x01, 0x11 ], sucExpect );
        ...
        checkPokerType( [ 0x01, 0x11, 0x21, 0x02, 0x12, 0x32, 0x31, 0x22 ], errExpect );
    ...
    describe( "三带二 飞机 CT_THREE_LINE_TAKE_TWO", function () {
        ...
        let errExpect = EPokerType.CT_ERROR;
        checkPokerType( [ 0x05, 0x15, 0x25, 0x06, 0x16, 0x26, 0x01, 0x11, 0x12, 0x22 ], sucExpect );
