import ServerPeer from "./core/tcp/ServerPeer";
import NetMsgCenter from "./Applications/NetMsgCenter";
...
class Main {
    ...
    private _start(): void {
        ...
        let netMsgCenter = new NetMsgCenter();
        server.setApplication( netMsgCenter );
        server.start( 9527, 10 );
    }
}
new Main();
