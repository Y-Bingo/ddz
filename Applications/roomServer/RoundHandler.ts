// import { m_cbPokerData, HAND_COUNT, FULL_COUNT, GAME_PLAYER } from "./ddz/gameLogic/Constant";
// import DDZRuleMaster from "./ddz/gameLogic/DDZRule";
// import { IRoomConf, EGameStatus } from "../../model/RoomModel";
// import { ChairHandler } from "./ChairHandler";
// import { sortByLogicFirst } from "../base/Sort";
// import { logPokes } from "../../utils/Log";

// // 游戏流程管理
// export class RoundHandler extends ChairHandler {
//     // 一副完整的牌
//     pokers: number[];
//     // 玩家手牌
//     hands: number[][];
